                            ...
                            <form action="dodaj.php" method="POST">
                                ...
                                <div className="agree">
                                    <div><input type="checkbox" value="checkbox"></input>
                                        <p className="textSmall">Zapoznałem się z <a href={politykaPrywatnosci} target="_blank" rel="noopener noreferrer">Polityką Prywatności </a>
       i akceptuję <a href={regulaminTaksidi} target="_blank" rel="noopener noreferrer">Regulamin Strony</a></p></div>
                                    <div><input type="checkbox" value="checkbox"></input>
